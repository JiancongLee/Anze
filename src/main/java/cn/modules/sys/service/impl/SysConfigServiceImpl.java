...
import cn.modules.security.redis.SysConfigRedis;
import cn.modules.sys.dao.SysConfigDao;
import cn.modules.sys.entity.SysConfigEntity;
import cn.modules.sys.service.SysConfigService;
...
public class SysConfigServiceImpl extends ServiceImpl<SysConfigDao, SysConfigEntity> implements SysConfigService {
	...
	public <T> T getConfigObject(String key, Class<T> clazz) {
		...
		try {
			...
			throw new DefaultException("获取参数失败");
		}
	}
}
